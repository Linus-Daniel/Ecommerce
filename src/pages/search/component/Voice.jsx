  ...
  return (
    <div className='absolute top-0 w-screen h-screen bg-black/60'>
      <section className='flex justify-center items-center w-full h-full'>
        ...
        <HiOutlineXCircle className='hover:text-red-400 transition-all ease-in-out duration-700 absolute top-[25%] right-[25%] text-slate-700 text-3xl'/>
        </button>
        <div className='rounded-3xl flex items-center justify-center  bg-white w-[70%] h-[60%]'>
            <div>
