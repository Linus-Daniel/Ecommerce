...
function LocalBank() {
    ...
    return (
        <div className='mx-5 mt-10'>
            ...
            <button type='submit' onClick={(e)=>{if(confirm("Do you want to proceed?")===true){console.log("hi")}else{e.preventDefault()};}} className='text-lg rounded-md bg-black text-white mb-10 w-full py-3'>I have made Transaction</button>
